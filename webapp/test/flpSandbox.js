		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mock Service Exercise_Tan",
									"targetURL": "#sapipstrainingmockservice2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingmockservice2-display": {
								"semanticObject": "sapipstrainingmockservice2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.mockservice2",
									"url": sap.ui.require.toUrl("sapips/training/mockservice2")
								}
							}
						}
					}
